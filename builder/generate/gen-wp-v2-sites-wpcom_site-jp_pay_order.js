 ...
 * endpoint: /sites/(?P<wpcom_site>[\w.:]+)/jp_pay_order
 * created at: 2018-07-21T21:36:04.914Z
 *
 * > sites <wpcom_site> jp_pay_order
 */

export default {
	description: '> sites <wpcom_site> jp_pay_order',
	exec: ( args, print, runCmd ) => {
		...
		const endpoint_base = 'https://public-api.wordpress.com/wp/v2/sites/wpcom_site/jp_pay_order';
