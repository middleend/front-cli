 ...
 * endpoint: /sites/(?P<wpcom_site>[\w.:]+)/pages/(?P<parent>[\d]+)/revisions
 * created at: 2018-07-21T21:36:04.913Z
 *
 * > sites <wpcom_site> pages <parent> revisions
 */

export default {
	description: '> sites <wpcom_site> pages <parent> revisions',
	exec: ( args, print, runCmd ) => {
		...
		const endpoint_base = 'https://public-api.wordpress.com/wp/v2/sites/wpcom_site/pages/parent/revisions';
