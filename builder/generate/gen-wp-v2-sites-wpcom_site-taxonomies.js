 ...
 * endpoint: /sites/(?P<wpcom_site>[\w.:]+)/taxonomies
 * created at: 2018-07-21T21:36:04.914Z
 *
 * > sites <wpcom_site> taxonomies
 */

export default {
	description: '> sites <wpcom_site> taxonomies',
	exec: ( args, print, runCmd ) => {
		...
		const endpoint_base = 'https://public-api.wordpress.com/wp/v2/sites/wpcom_site/taxonomies';
