 ...
 * endpoint: /sites/(?P<wpcom_site>[\w.:]+)/categories
 * created at: 2018-07-21T21:36:04.915Z
 *
 * > sites <wpcom_site> categories
 */

export default {
	description: '> sites <wpcom_site> categories',
	exec: ( args, print, runCmd ) => {
		...
		const endpoint_base = 'https://public-api.wordpress.com/wp/v2/sites/wpcom_site/categories';
