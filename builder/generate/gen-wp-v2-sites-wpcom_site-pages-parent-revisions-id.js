...
export default {
	description: '> sites <wpcom_site> pages <parent> revisions <id>',
	exec: ( args, print, runCmd ) => {
		...
		const endpoint_base = 'https://public-api.wordpress.com/wp/v2/sites/wpcom_site/pages/parent/revisions/id';
